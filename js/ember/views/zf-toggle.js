console.log('toggle-view loaded');


/**
  `Ember.ZfToggleView` renders an element whose `click` event triggers a
  transition of the application's instance of `Ember.Router` to
  a supplied route by name.

  Instances of `ZfToggleView` will most likely be created through
...
**/
var ZfToggleView = Ember.ZfToggleView = EmberComponent.extend({
  tagName: 'a',
  ...
  */
  ...
  /**
    Used to determine when this ZfToggleView is active.
  ...
  */
  ...
  /**
    Sets the `title` attribute of the `ZfToggleView`'s HTML element.
  ...
  **/
  ...
  /**
    Sets the `rel` attribute of the `ZfToggleView`'s HTML element.
  ...
  **/
  ...
  /**
    The CSS class to apply to `ZfToggleView`'s element when its `active`
    property is `true`.
  ...
  **/
  ...
  /**
    The CSS class to apply to `ZfToggleView`'s element when its `loading`
    property is `true`.
  ...
  **/
  ...
  /**
    The CSS class to apply to a `ZfToggleView`'s element when its `disabled`
    property is `true`.
  ...
  **/
  ...
  /**
    Determines whether the `ZfToggleView` will trigger routing via
  ...
  */
  ...
  /**
    Triggers the `ZfToggleView`'s routing behavior. If
  ...
  **/
  ...
  /**
    An overridable method called when ZfToggleView objects are instantiated.

    Example:

    ```javascript
    App.MyZfToggleView = Ember.ZfToggleView.extend({
      init: function() {
        this._super();
  ...
  **/
  ...
  /**
    ...
    Accessed as a classname binding to apply the `ZfToggleView`'s `disabledClass`
    CSS `class` to the element when the link is disabled.

    When `true` interactions with the element will not trigger route changes.
    @property disabled
  */
  disabled: computed(function computeZfToggleViewDisabled(key, value) {
  ...
  /**
    Accessed as a classname binding to apply the `ZfToggleView`'s `activeClass`
    CSS `class` to the element when the link is active.

    A `ZfToggleView` is considered active when its `currentWhen` property is `true`
    or the application's current route is the route the `ZfToggleView` would trigger
    transitions into.
    ...
    @property active
  **/
  active: computed('loadedParams', function computeZfToggleViewActive() {
  ...
  /**
    Accessed as a classname binding to apply the `ZfToggleView`'s `loadingClass`
    CSS `class` to the element when the link is loading.

    A `ZfToggleView` is considered loading when it has at least one
    ...
    @property loading
  **/
  loading: computed('loadedParams', function computeZfToggleViewLoading() {
  ...
  **/
  loadedParams: computed('resolvedParams', function computeZfToggleViewRouteArgs() {
    var router = get(this, 'router');
    if (!router) { return; }
  ...
  /**
    ...
    the `ZfToggleView`'s targeted route.

    If the `ZfToggleView`'s `tagName` is changed to a value other
    than `a`, this property will be ignored.

    @property href
  **/
  href: computed('loadedParams', function computeZfToggleViewHref() {
...
// ZfToggleView.toString = function() {
//   return "ZfToggleView";
// };
...
//   attributeBindings: ['target'],
  ...
  /**
    Sets the `target` attribute of the `ZfToggleView`'s anchor element.
